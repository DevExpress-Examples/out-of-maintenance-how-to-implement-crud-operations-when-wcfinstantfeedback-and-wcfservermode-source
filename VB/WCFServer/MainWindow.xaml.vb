...
Imports WCFServer.ServiceReference1

Namespace WCFServer
	Partial Public Class MainWindow
		Inherits Window
		Public Shared ReadOnly EntitiesProperty As DependencyProperty = DependencyProperty.Register("Entities", GetType(DatabaseEntities), GetType(MainWindow), New PropertyMetadata(Nothing))
