...
' Original file name:
' Generation date: 22/2/2012 9:45:34 AM
	...
	Partial Public Class DatabaseEntities
		...
		Protected Function ResolveTypeFromName(ByVal typeName As String) As Global.System.Type
			If typeName.StartsWith("DatabaseModel", Global.System.StringComparison.Ordinal) Then
				Return Me.GetType().Assembly.GetType(String.Concat("WCFServer.ServiceReference1", typeName.Substring(13)), False)
			End If
			Return Nothing
		End Function
		''' <summary>
		...
		Protected Function ResolveNameFromType(ByVal clientType As Global.System.Type) As String
			If clientType.Namespace.Equals("WCFServer.ServiceReference1", Global.System.StringComparison.Ordinal) Then
